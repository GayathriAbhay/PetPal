...
const SignInModal = ({ open, onClose }: { open: boolean; onClose: () => void }) => {
  ...
  return (
    <div aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-w-md w-full bg-card p-6 rounded-2xl shadow max-h-[90vh] overflow-auto mx-auto">
